...
- 数据：环境锚定邻域采样（每点真实 BER_MLSE），覆盖信任域 FFE ±0.1 / CTLE ±3.0 dB；n_train=599, n_test=149
- 数据文件：`dataset\ddps_v2_dataset_20260907_190819.csv`；标签列：`log10_ber_mlse`
- **Model A**（Tx 7-tap FIR → log10 BER_MLSE，寻优目标）：Test R²=0.379, Spearman=0.649
- **Model B**（FFE+CTLE 配置 → log10 BER_MLSE，安全约束）：Test R²=0.242, Spearman=0.475
...
| --- | --- | --- | --- | --- | --- | --- |
| Base_IL10 | `5.53e-04` | `3.35e-04` (step 4) | `-0.22` | 12 | ✅ 改善 | 0.41 |
| IL_Sweep_14dB | `2.08e-03` | `5.66e-04` (step 5) | `-0.56` | 10 | ✅ 改善 | 0.65 |
| IL_Worst_20dB | `5.82e-02` | `2.97e-03` (step 7) | `-1.29` | 11 | ✅ 改善 | 0.75 |
| CD_Sweep_15ps | `6.57e-04` | `3.35e-04` (step 5) | `-0.29` | 12 | ✅ 改善 | 0.46 |
| CD_Sweep_28ps | `6.94e-04` | `3.39e-04` (step 6) | `-0.31` | 12 | ✅ 改善 | 0.66 |
| DGD_Sweep_2ps | `4.42e-04` | `3.35e-04` (step 4) | `-0.12` | 12 | ✅ 改善 | 0.42 |
| DGD_Sweep_5ps | `4.71e-04` | `3.39e-04` (step 4) | `-0.14` | 12 | ✅ 改善 | -0.17 |
| Combined_Stress | `7.72e-02` | `5.74e-03` (step 9) | `-1.13` | 11 | ✅ 改善 | 0.99 |
